...
- [vue-draggable-plus](https://vue-draggable-plus.pages.dev/guide/) 基于Sortable.js实现的vue拖拽插件(Vue 3)
...
- [开源Office 办公套件 Univer (原Luckyexcel)](https://univer.ai/zh-CN)


## 其他
- [H5带笔锋手写签名，支持PC端和移动端](https://github.com/linjc/smooth-signature)
- [PingFang SC字体下载](https://pan.baidu.com/s/1xOOIJGjopRdsexXuC6FkVQ):  密码:fq72
